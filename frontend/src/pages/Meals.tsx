      ...
      <div className="bg-gradient-to-br from-blue-50 to-green-50 min-h-screen w-full py-12">
        <div className="max-w-6xl mx-auto flex flex-col gap-6">
          ...
          <div className="w-full">
            <div className="flex flex-row items-end justify-between w-full mb-1">
              <div className="flex items-center gap-2">
                <Calendar className="w-7 h-7 text-green-600" />
                <h2 className="text-2xl font-bold text-blue-900 m-0 p-0">Personalized Meal Plan Calendar</h2>
              </div>
              <p className="text-gray-600 text-right m-0 p-0">This calendar shows your personalized meal plan generated by the AI, based on your preferences and logged meals.</p>
            </div>
