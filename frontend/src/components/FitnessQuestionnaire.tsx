...
const FitnessQuestionnaire = ({ userId, onComplete }: { userId: string, onComplete: (goals: any) => void }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/50 transition-all duration-300 hover:shadow-[0_8px_32px_0_rgba(236,72,153,0.15)] hover:border-pink-400/80 hover:ring-4 hover:ring-pink-200/40">
